...
public class PagingScrollHelper {
    ...
    private OnListener<Integer> mOnPageChangeListener;
    ...
    /**
     * do after setLayoutManager
     */
    public PagingScrollHelper(RecyclerView mRecyclerView,OnListener<Integer> onListener) {
        if (mRecyclerView == null) {
            throw new IllegalArgumentException("recycleView must be not null");
        }
        this.mRecyclerView = mRecyclerView;
        this.mOnPageChangeListener = onListener;
        init();
    }
                ...
                mAnimator.addListener(new AnimatorListenerAdapter() {
                    ...
                    public void onAnimationEnd(Animator animation) {
                        ...
                        if (null != mOnPageChangeListener) {
                            mOnPageChangeListener.onListen(getPageIndex());
                        }
                    }
                });
            } else {
    ...
    private class MyOnScrollListener extends RecyclerView.OnScrollListener {
        ...
        public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
            ...
            if (newState == 0 && mOrientation != ORIENTATION.NULL) {
                ...
                if(vX>0||vY>0)mOnFlingListener.onFling(vX, vY);
            }
        }
