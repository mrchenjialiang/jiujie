 ...
 */
public abstract class BaseScrollKeepHeaderActivity extends BaseActivity implements AppBarLayout.OnOffsetChangedListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void initView() {
        super.initView();
        AppBarLayout appBarLayout = (AppBarLayout) findViewById(R.id.bskh_appBar);
        appBarLayout.addOnOffsetChangedListener(this);

        mSwipeRefreshLayout = (SwipeRefreshLayout) findViewById(R.id.bskh_swipeRefreshLayout);
        mSwipeRefreshLayout.setOnRefreshListener(this);
        mSwipeRefreshLayout.setColorSchemeColors(ContextCompat.getColor(mActivity,R.color.refresh_color));

        mMissLine = findViewById(R.id.bskh_dissmiss_line);
        mKeepTopLine = findViewById(R.id.bskh_keep_top_line);
        mScrollLine = findViewById(R.id.bskh_scroll_line);
