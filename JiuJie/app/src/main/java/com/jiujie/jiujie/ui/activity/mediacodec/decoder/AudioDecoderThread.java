            ...
            if (inIndex >= 0) {
                ...
                switch (outIndex) {
                    ...
                    case MediaCodec.INFO_OUTPUT_FORMAT_CHANGED:
                        ...
                        Log.d("VideoDecoderDemo1Activity", "New format " + format);
                    ...
                    default:
                        ...
                        Log.v("VideoDecoderDemo1Activity", "We can't use this buffer but render it due to the API limit, " + outBuffer);
