...
public class ChoosePhotoActivity extends BaseActivity{
    ...
    public static void launch(Activity activity, int maxCheckCount, List<String> checkedList, ICallbackSimple<List<String>> callbackSimple){
    ...
    public void initUI() {
        ...
        mMainAdapter = new ChoosePhotoAdapter(mActivity,mMainDataList,maxCheckCount);
