...
/**
 * footer and header should add by yourself
 * Created by ChenJiaLiang on 2016/4/14.
 * T : data type
 * V : ViewHolder
 */
public abstract class BaseRecyclerViewSimpleAdapter<T,V extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public BaseRecyclerViewSimpleAdapter(List<T> dataList) {
...
//                ViewGroup.LayoutParams.WRAP_CONTENT));
        V itemViewHolder = getItemViewHolder(view, viewType);
    ...
    public abstract V getItemViewHolder(View view, int viewType);

    public abstract void onBindItemViewHolder(V h, T d,int position);
    ...
    public final void onBindViewHolder(final RecyclerView.ViewHolder holder, int position){
        ...
        if(itemViewType !=TYPE_HEADER&&itemViewType!=TYPE_FOOTER){
            ...
            if(p<0||p>dataList.size()-1){
                onBindItemViewHolder((V)holder, null,p);
            }else{
                onBindItemViewHolder((V)holder, dataList.get(p),p);
            }
        }
