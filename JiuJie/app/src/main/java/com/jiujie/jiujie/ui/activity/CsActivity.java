...
public class CsActivity extends MyBaseActivity {
    ...
    public static void launch(Activity activity) {
        activity.startActivity(new Intent(activity,CsActivity.class));
    }
    ...
    private void showSplashAd() {
        AdManager.instance(mActivity).fetchSplashAD(this, cs_ad_container, ad_pass, new OnSplashAdListener() {
            ...
            public void onADDismissed() {
                ...
                UIHelper.showLog(CsActivity.this, "onADDismissed");
            }

            @Override
            public void onNoAD() {
                UIHelper.showLog(CsActivity.this, "onNoAD");
            }

            @Override
            public void onADPresent() {
                UIHelper.showLog(CsActivity.this, "onADPresent");
            }
            @Override
            public void onADTick(long time) {
                UIHelper.showLog(CsActivity.this, "onADTick time:"+time);
            }

            @Override
            public void onADClicked() {
                UIHelper.showLog(CsActivity.this, "onADClicked");
            }
        });
    }
}
