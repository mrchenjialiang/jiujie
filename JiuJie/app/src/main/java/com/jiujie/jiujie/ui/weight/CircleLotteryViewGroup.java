...
public class CircleLotteryViewGroup extends ViewGroup {
    ...
    public CircleLotteryViewGroup(@NonNull Context context) {
        super(context);
        init();
    }

    public CircleLotteryViewGroup(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public CircleLotteryViewGroup(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
...
//        canvas.drawColor(Color.TRANSPARENT);
        ...
        singleAngle = 360 * 1.0f / circleAllItemSize;
