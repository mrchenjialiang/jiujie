...
public class SurfaceViewUtil implements VideoController{
    private final String TAG = "SurfaceViewUtil";
     ...
     */
    public SurfaceViewUtil(SurfaceView surfaceView,boolean isLoop,boolean isAutoStart,ViewGroup containerView) {
...
//        mMediaPlayer.setAudioStreamType(AudioManager.STREAM_MUSIC);
    ...
    private class SurfaceViewLis implements SurfaceHolder.Callback {
        ...
        public void surfaceCreated(SurfaceHolder holder) {
            UIHelper.showLog("SurfaceViewLis surfaceCreated url "+url);
